...
export const DEFAULT_ITEMS: DefaultItem[] = [
  ...
  { slug: "keczup", displayName: "Keczup", emoji: "\u{1F345}", unit: "butelka 500ml", maxQuantity: 3 },
  { slug: "musztarda", displayName: "Musztarda", emoji: "\u{1F7E1}", unit: "butelka", maxQuantity: 3 },
  ...
  { slug: "talerzyki", displayName: "Talerzyki papierowe", emoji: "\u{1F37D}\uFE0F", unit: "sztuka", maxQuantity: 80 },
  { slug: "kubeczki", displayName: "Kubeczki", emoji: "\u{1F964}", unit: "sztuka", maxQuantity: 80 },
